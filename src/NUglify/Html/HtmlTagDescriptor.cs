...
namespace NUglify.Html
{
    public class HtmlTagDescriptor
    {
        ...
        private static readonly Dictionary<string, HtmlTagDescriptor> TagDescriptors = new Dictionary<string, HtmlTagDescriptor>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["math"] = new HtmlTagDescriptor(ContentKind.Flow | ContentKind.Phrasing | ContentKind.Embedded | ContentKind.Palpable | ContentKind.Xml, ContentKind.Any),
            ...
            ["svg"] = new HtmlTagDescriptor(ContentKind.Flow | ContentKind.Phrasing | ContentKind.Embedded | ContentKind.Palpable | ContentKind.Xml, ContentKind.Any),
