...
namespace NUglify.JavaScript.Syntax
{
    ...
    public sealed class LookupExpression : Expression, INameReference, IRenameable
    {
        ...
        public bool IsAssignment
        {
            get
            {
                ...
                var binaryOp = Parent as BinaryExpression;
                if (binaryOp != null)
                {
                ...
                else
                {
                    ...
                    var unaryOp = Parent as UnaryExpression;
                    ...
                    if (!isAssign)
                    {
                        ...
                        var forIn = Parent as ForInStatement;
